...
# Filesystem
TARGET_FS_CONFIG_GEN := device/samsung/hltedcm/config.fs

# HIDL
DEVICE_MANIFEST_FILE += device/samsung/hltedcm/manifest.xml

# Legacy BLOB Support
TARGET_NEEDS_PLATFORM_TEXT_RELOCATIONS := true

# LineageHW
BOARD_HARDWARE_CLASS += device/samsung/hltedcm/lineagehw
...
# Properties
TARGET_SYSTEM_PROP += device/samsung/hltedcm/system.prop
...
# Recovery
ifneq ($(RECOVERY_VARIANT),twrp)
TARGET_RECOVERY_FSTAB := device/samsung/hltedcm/rootdir/etc/fstab.full
endif
...
# SELinux
include device/samsung/hltedcm/sepolicy/sepolicy.mk
